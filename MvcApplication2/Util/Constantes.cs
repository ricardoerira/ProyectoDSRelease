...
namespace MvcApplication2.Util
{
    public class Constantes
    {
        ...
        public static string[] documentos_docente = { "doc_identidad", "acta_grado", "dip_prof", "acta_grado_post", "dip_espe", "doc_tpd", "doc_tpn",  "carne_EPS","cv1", "cv2", "ant_varicela", "ant_hp", "influenza" };
