...
namespace MvcApplication2.Controllers
{
    public class DocenteController : Controller
    {
        ...
        {
            var docentes = db.Docentes.Include(d => d.DepartamentoSalud).Include(d => d.HojaVida);
        ...
        public ActionResult DeleteImage(int id)
        {
            ...
            return RedirectToAction("../Docente/Personales/" + docente.docenteId);
        ...
        public ActionResult cargaDocumentos(Docente docente)
        {
            ...
            if (Utilidades.remoteFileExists(path1))
            {
                ...
                ViewBag.imagen12a = Constantes.documentos_docente[11] + docente.num_documento + ".jpg";
            ...
            if (Utilidades.remoteFileExists(path1))
            {
                ...
                ViewBag.imagen13a = Constantes.documentos_docente[12] + docente.num_documento + ".jpg";
            ...
            path1 = string.Format("{0}/{1}{2}", Constantes.url_folder, Constantes.documentos_docente[13] + docente.num_documento, ".jpg");
            ...
            if (Utilidades.remoteFileExists(path1))
            {
                ...
                ViewBag.imagen14a = Constantes.documentos_docente[13] + docente.num_documento + ".jpg";
        ...
        public ActionResult SolicitarActualizacion(Docente docente)
        {
            ...
            if (docente.HojaVida.correo != null && !docente.HojaVida.correo.Equals(""))
            {
        ...
        public void guardaDocumentos(Docente docente)
        {
        ...
        public Boolean validarCampos(Docente docente)
        {
